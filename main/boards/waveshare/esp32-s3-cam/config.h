...
#define PWR_BUTTON_GPIO  GPIO_NUM_15
...
#define BSP_IO_EXPANDER_I2C_ADDRESS_FALLBACK 0x24
...
/* PowerManager compatibility: real BAT_EN is on CH32 EXIO5, not ESP32 GPIO */
#define BATTERY_CHARGING_PIN GPIO_NUM_NC
#define BATTERY_ADC_PIN      GPIO_NUM_NC
#define BATTERY_EN_PIN       GPIO_NUM_NC

/* CH32V003 expander pin map from board schematic */
#define EXIO_LCD_RST   IO_EXPANDER_PIN_NUM_1
#define EXIO_CAM_PWDN  IO_EXPANDER_PIN_NUM_3
#define EXIO_PA_CTRL   IO_EXPANDER_PIN_NUM_4
#define EXIO_BAT_EN    IO_EXPANDER_PIN_NUM_5
#define EXIO_PWR_LED   IO_EXPANDER_PIN_NUM_6
#define EXIO_CHG_DET   IO_EXPANDER_PIN_NUM_7
